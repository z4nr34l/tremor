...
export type ColStart = typeof twColStartValues[number];

const twColEndValues = [
    'col-end-1',
    'col-end-2',
    'col-end-3',
    'col-end-4',
...
export type ColEnd = typeof twColEndValues[number];

const twColSpanValues = [
    'col-span-1',
    'col-span-2',
    'col-span-3',
    'col-span-4',
...
export type ColSpan = typeof twColSpanValues[number];
