...
export const parseMaxWidth = (input: MaxWidth): string => {
    const prefixMapping: {[key in MaxWidth]: string} = {
        'max-w-0': 'tr-max-w-0',
...
export const parseSpaceX = (input: SpaceX): string => {
    const prefixMapping: {[key in SpaceX]: string} = {
...
export const parseSpaceY = (input: SpaceY): string => {
    const prefixMapping: {[key in SpaceY]: string} = {
...
export const parseMarginTop = (input: MarginTop): string => {
    const prefixMapping: {[key in MarginTop]: string} = {
        'mt-0': 'tr-mt-0',
        'mt-0.5': 'tr-mt-0.5',
        'mt-1': 'tr-mt-1',
        'mt-1.5': 'tr-mt-1.5',
...
export const parseHeight = (input: Height): string => {
    const prefixMapping: {[key in Height]: string} = {
        'h-0': 'tr-h-0',
        'h-0.5': 'tr-h-0.5',
        'h-1': 'tr-h-1',
        'h-1.5': 'tr-h-1.5',
...
export const parseWidth = (input: Width): string => {
    const prefixMapping: {[key in Width]: string} = {
        'w-0': 'tr-w-0',
        'w-0.5': 'tr-w-0.5',
        'w-1': 'tr-w-1',
        'w-1.5': 'tr-w-1.5',
...
export const parseGapX = (input: GapX): string => {
    const prefixMapping: {[key in GapX]: string} = {
        'gap-x-0': 'tr-gap-x-0',
...
export const parseGapY = (input: GapY): string => {
    const prefixMapping: {[key in GapY]: string} = {
        'gap-y-0': 'tr-gap-y-0',
