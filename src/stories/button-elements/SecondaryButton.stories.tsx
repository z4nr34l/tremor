...
import SecondaryButton from 'components/button-elements/SecondaryButton/SecondaryButton';

// More on default export: https://storybook.js.org/docs/react/writing-stories/introduction#default-export
export default {
    title: 'Tremor/ButtonElements/SecondaryButton',
...
const Template: ComponentStory<typeof SecondaryButton> = (args) => (
    <Flex>
        <div>Hello</div>
        <SecondaryButton {...args} text={ 'Button text' } />
    </Flex>
);
