...
export const colorMapping: {[style: string]: {[baseColor: string]: IconElementColorTypes}} = {
    ...
    'shadow': {
        'slate': { 
            ...
            borderColor: getColorVariantsFromColorThemeValue(defaultColors['light']).borderColor,
            ringColor: '',
        },
        'gray': { 
            textColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Gray].text).textColor,
    ...
    'solid': {
        'slate': { 
            ...
            ringColor: getColorVariantsFromColorThemeValue(defaultColors['light']).ringRolor,
        },
        'gray': { 
            textColor: getColorVariantsFromColorThemeValue(defaultColors['white']).textColor,
