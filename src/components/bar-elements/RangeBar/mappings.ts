...
export const colors: {[baseColor: string]: PeerComparisonBarColorTypes} = {
    'slate': {
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Slate].background).bgColor,
    },
    'gray': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Gray].background).bgColor,
    },
    'zinc': {
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Zinc].background).bgColor,
    },
    'neutral': {
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Neutral].background).bgColor,
    },
    'stone': { 
    ...
    'orange': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Orange].background).bgColor,
    },
    'amber': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Amber].background).bgColor,
    },
    'yellow': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Yellow].background).bgColor,
    },
    'lime': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Lime].background).bgColor,
    },
    'green': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Green].background).bgColor,
    },
    'emerald': { 
        primaryBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Emerald].background).bgColor,
        secondaryBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Emerald].lightBackground).bgColor,
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Emerald].background).bgColor,
    },
    'teal': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Teal].background).bgColor,
    },
    'cyan': {
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Cyan].background).bgColor,
    },
    'sky': {
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Sky].background).bgColor,
    },
    'blue': { 
    ...
    'indigo': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Indigo].background).bgColor,
    },
    'violet': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Violet].background).bgColor,
    },
    'purple': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Purple].background).bgColor,
    },
    'fuchsia': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Fuchsia].background).bgColor,
    },
    'pink': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Pink].background).bgColor,
    },
    'rose': { 
        ...
        markerBgColor: getColorVariantsFromColorThemeValue(colorTheme[BaseColors.Rose].background).bgColor,
    }
};
